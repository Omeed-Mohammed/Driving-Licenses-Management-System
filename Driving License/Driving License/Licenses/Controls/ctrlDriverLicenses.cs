using Driving_License.Licenses.International_Licenses;
...
namespace Driving_License.Licenses.Controls
{
    public partial class ctrlDriverLicenses : UserControl
    {
        ...
        public void LoadInfo(int DriverID)
        {
            ...
            if (_Driver == null)
            {
                string Message = "There is no Driver with id = ";
                MessageBox.Show(Message + _DriverID, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
        ...
        public void LoadInfoByPersonID(int PersonID)
        {
            ...
            if (_Driver == null)
            {
                string Message = "There is no Driver liked with Person id = ";
                MessageBox.Show(Message + PersonID, "Error", MessageBoxButtons.OK, MessageBoxIcon.Error);
                return;
            }
