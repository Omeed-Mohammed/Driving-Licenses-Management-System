...
using Driving_License.Licenses;
...
namespace Driving_License.App.Rlease_Detained_License
{
    public partial class frmReleaseDetainedLicenseApplication : Form
    {
        ...
        private void ctrlDriverLicenseInfoWithFilter1_OnLicenseSelected(int obj)
        {
            ...
            int Type = (int)clsApplication.enApplicationType.ReleaseDetainedDrivingLicense;
            ...
            DateTime detainDate = ctrlDriverLicenseInfoWithFilter1.SelectedLicenseInfo.DetainedInfo.DetainDate;
