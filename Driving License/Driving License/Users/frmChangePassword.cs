...
namespace Driving_License.Users
{
    public partial class frmChangePassword : Form
    {
        ...
        private void btnSave_Click(object sender, EventArgs e)
        {
            ...
            {
                //Here we don't continue because the form is not valid
                MessageBox.Show("Some filed are not valid!, put the mouse over the red icon(s) to see the erro",
        ...
        //***************************************************************************************
        private void _showPass(bool choice)
        {
            txtNewPassword.UseSystemPasswordChar = choice;
            txtConfirmPassword.UseSystemPasswordChar = choice;
        }
